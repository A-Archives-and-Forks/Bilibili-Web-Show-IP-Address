/**
 * 原始代码来自：Hook Vue3 app
 * https://greasyfork.org/zh-CN/scripts/449444-hook-vue3-app
 */
...
const removeAppFromRecord = (
  record: VueAppRecord | undefined,
  app: VueApp,
): VueAppRecord | undefined => {
